...
export const ruLocale = {
  ...
  ...{
    ...
    welcomePage: {
      goalText: "Наша цель - предоставить независимым ученым и другим исследователям возможность публиковать свои работы или препринты и делиться ими со всем миром",
