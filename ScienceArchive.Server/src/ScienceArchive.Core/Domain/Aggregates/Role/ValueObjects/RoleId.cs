...
public sealed class RoleId : GuidEntityId
{
    ...
    public static RoleId CreateNew()
    {
    ...
    /// </exception>
    public static RoleId CreateFromString(string value)
    {
        if (!Guid.TryParse(value, out var idValue))
        {
            throw new InvalidEntityIdValueException(value, nameof(RoleId));
        }
    ...
    /// </exception>
    public static RoleId CreateFromGuid(Guid value)
    {
